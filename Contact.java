   ...
   private String NrTel;
    ...
    private Contact(String nume, String prenume,String NrTel,String dataNasterii){
        ...
        if (!valideazaNume(nume)) {
            throw new RuntimeException(sError.toString());
        }
    ...
    public static Contact getInstance(String nume,String prenume,String NrTel, String dataNasterii,StringBuilder sError ){
       if(!valideazaNume(nume)){
           return null;
       }
       if(!valideazaPrenume(prenume)){
